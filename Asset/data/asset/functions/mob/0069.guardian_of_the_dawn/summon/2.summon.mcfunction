#> asset:mob/0069.guardian_of_the_dawn/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0069.guardian_of_the_dawn/summon/1.trigger

# 元となるMobを召喚する
    summon skeleton ~ ~ ~ {Tags:["MobInit"],DeathLootTable:"asset:mob/death/0069.guardian_of_the_dawn"}
# ID (int)
    data modify storage asset:mob ID set value 69
# Type (string) Wikiを参照
    data modify storage asset:mob Type set value "Enemy"
# 干渉可能か否か (boolean)
    data modify storage asset:mob Interferable set value true
# 名前 (TextComponentString) (オプション)
    data modify storage asset:mob Name set value '{"text":"黎明の守護","color":"black"}'
# 武器
