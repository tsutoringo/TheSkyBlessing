#> asset:mob/0070.guardian_of_the_morning/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0070.guardian_of_the_morning/summon/1.trigger

# 元となるMobを召喚する
    summon skeleton ~ ~ ~ {Tags:["MobInit"],DeathLootTable:"asset:mob/death/0070.guardian_of_the_morning"}
# ID (int)
    data modify storage asset:mob ID set value 70
# Type (string) Wikiを参照
    data modify storage asset:mob Type set value "Enemy"
# 干渉可能か否か (boolean)
    data modify storage asset:mob Interferable set value true
# 名前 (TextComponentString) (オプション)
    data modify storage asset:mob Name set value '{"text":"早朝の守護","color":"black"}'
# 武器
